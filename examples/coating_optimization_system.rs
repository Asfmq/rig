...
async fn create_coating_optimization_system(
    ...
    let iteration_result = orchestrator
        .prompt(iteration_request)
        .multi_turn(15)
        .await?;
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    println!("║                                                            ║");
    println!("║        涂层性能预测及优化专家系统                         ║");
    println!("║        Coating Performance Prediction & Optimization       ║");
    println!("║                                                            ║");
    println!("║        基于 Rig Framework + Qwen Plus                     ║");
    println!("║        多 Agent 协作系统示例                              ║");
    println!("║                                                            ║");
    println!("╚════════════════════════════════════════════════════════════╝");
    println!("\n");
    ...
    println!("\n✓ 系统运行完成");
    println!("\n本示例展示了：");
    println!("  1. 复杂的多 Agent 编排（6个专业Agent + 1个编排器）");
    println!("  2. Agent-as-Tool 模式的应用");
    println!("  3. 工具集成（模拟的专业工具）");
